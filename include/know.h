...
struct MdrString* snippet_get(struct Know*, const struct MdrString*);
...
struct MdrString* file_get(struct Know*, const struct MdrString*);
void file_set(struct Know *, const char*, const struct MdrString*);
